...
**Our goal is to recreate the state where the SCP: Dystopia addon was working without any issues.**

To achieve that, I learned that I have to pause development of new features,
and focus on restoration part first.

I decided that it would be too difficult to carry out this restoration work with so many incomplete new features.
Therefore, I'm doing it from scratch.
